...
// @ts-ignore
import { GameStatisticDetailed } from '../model/gameStatisticDetailed';
// @ts-ignore
...
export class ProfileService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public profileGetPlayerStatsGet(mode?: Gamemode, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<GameStatisticDetailed>;
    public profileGetPlayerStatsGet(mode?: Gamemode, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpResponse<GameStatisticDetailed>>;
    public profileGetPlayerStatsGet(mode?: Gamemode, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpEvent<GameStatisticDetailed>>;
    public profileGetPlayerStatsGet(mode?: Gamemode, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<GameStatisticDetailed>(`${this.configuration.basePath}/profile/GetPlayerStats`,
            {
                context: localVarHttpContext,
